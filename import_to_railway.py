...
MUST set DATABASE_URL before importing anything!
"""

import os
# SET RAILWAY DATABASE_URL FIRST (before any imports)
...
# Now import and run the import script
import asyncio
import pandas as pd
...
async def import_from_csv():
    ...
    print("="*80)
    print("RAILWAY IMPORT - ZOHO CSV INVOICE DATA")
    print("="*80)
    ...
    print("\n[5] IMPORTING TO RAILWAY DATABASE")
    print("-"*80)

    async with AsyncSessionLocal() as session:
        # Clear existing
        print("  Clearing existing invoices from Railway...")
